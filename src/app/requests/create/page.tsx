            ...
            <CardContent>
              <form onSubmit={handleSubmit} className="space-y-6">
                <div className="space-y-2">
                  <Label htmlFor="title" className="text-white">任务标题</Label>
                  <Input 
                    id="title"
                ...
                <div className="space-y-2">
                  <Label htmlFor="description" className="text-white">需求描述</Label>
                  <Textarea 
                    id="description"
                ...
                <div className="space-y-2">
                  <Label htmlFor="budget" className="text-white">悬赏金额 (A币)</Label>
