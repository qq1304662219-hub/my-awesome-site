      ...
      <div className="relative py-20 overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10 text-center">
            ...
            <div className="flex justify-center gap-4">
                ...
                <Button variant="outline" className="border-border hover:bg-muted px-8 py-6 text-lg">
                    成为讲师
                </Button>
            </div>
        </div>
      ...
      <div className="flex-1 container mx-auto px-4 py-12">
        {(!courses || courses.length === 0) ? (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                {courses.map((course) => (
                    <div key={course.id} className="bg-card border border-border rounded-xl overflow-hidden hover:border-blue-500/50 transition-all group">
                        ...
                        <div className="p-5">
                            <h3 className="font-bold text-lg mb-2 line-clamp-1 group-hover:text-blue-500 transition-colors text-foreground">
                                {course.title}
                            </h3>
