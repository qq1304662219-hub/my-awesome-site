        ...
        <div className="min-h-screen bg-[#020817] text-white selection:bg-blue-500/30">
            ...
            <div className="relative pt-32 pb-20 overflow-hidden">
                ...
                <div className="container mx-auto px-4 relative z-10 text-center">
                    ...
                    <h1 className="text-5xl md:text-6xl font-bold mb-6 bg-clip-text text-transparent bg-gradient-to-r from-white via-blue-100 to-blue-200">
                        认证中心
                    </h1>
            ...
            <div className="container mx-auto px-4 pb-24">
                <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
                    {/* Individual */}
                    <Card className="bg-[#0f172a] border-white/10 hover:border-blue-500/50 transition-all duration-300 relative overflow-hidden group">
                        ...
                        <CardContent className="p-8 relative">
                            <div className="w-16 h-16 rounded-2xl bg-blue-500/10 flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300">
                                <UserBadge className="w-8 h-8 text-blue-400" />
                            </div>
                            <h3 className="text-2xl font-bold text-white mb-2">个人创作者认证</h3>
                            <p className="text-gray-400 mb-6 min-h-[48px]">适合独立 AI 艺术家、视频创作者、设计师申请，彰显个人专业影响力。</p>
                            ...
                            <Button className="w-full bg-blue-600 hover:bg-blue-700" onClick={() => handleApplyClick("individual")}>
                                立即申请
                            </Button>
                        </CardContent>
                    </Card>
                    ...
                    {/* Organization */}
                    <Card className="bg-[#0f172a] border-white/10 hover:border-purple-500/50 transition-all duration-300 relative overflow-hidden group">
                        ...
                        <CardContent className="p-8 relative">
                            <div className="w-16 h-16 rounded-2xl bg-purple-500/10 flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300">
                                <BuildingBadge className="w-8 h-8 text-purple-400" />
                            </div>
                            <h3 className="text-2xl font-bold text-white mb-2">机构/团队认证</h3>
                            <p className="text-gray-400 mb-6 min-h-[48px]">适合设计工作室、MCN 机构、影视公司申请，打造企业级品牌形象。</p>
                            <ul className="space-y-3 mb-8">
                                <li className="flex items-center text-sm text-gray-300">
            ...
            {/* Benefits Grid */}
            <div className="bg-[#0f172a]/50 py-20 border-y border-white/5">
                <div className="container mx-auto px-4">
                    <div className="text-center mb-16">
                        <h2 className="text-3xl font-bold text-white mb-4">认证权益</h2>
                        <p className="text-gray-400">成为认证创作者，享受全方位的平台赋能</p>
                    </div>
                    ...
                    <div className="grid md:grid-cols-4 gap-6">
                        {[
                            ...
                            <div key={i} className="bg-[#020817] p-6 rounded-xl border border-white/5 hover:border-white/10 transition-colors">
                ...
                <DialogContent className="sm:max-w-[600px] bg-[#0f172a] border-white/10 text-white">
                    ...
                    <div className="space-y-6 py-4">
                        <div className="space-y-2">
                            ...
                            <Input 
                                placeholder="https://..." 
                                className="bg-[#020817] border-white/10 text-white placeholder:text-gray-600 focus:border-blue-500"
                        ...
                        <div className="space-y-2">
                            ...
                            <Textarea 
                                ...
                                className="bg-[#020817] border-white/10 text-white placeholder:text-gray-600 min-h-[100px] focus:border-blue-500"
                    ...
                    <DialogFooter>
                        <Button variant="outline" onClick={() => setIsApplyOpen(false)} className="border-white/10 hover:bg-white/5 text-gray-300">
                            取消
                        </Button>
                        <Button onClick={submitApplication} disabled={loading} className="bg-blue-600 hover:bg-blue-700 text-white">
