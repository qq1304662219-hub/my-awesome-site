    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-muted-foreground mt-2">管理平台的在线课程内容</p>
        </div>
      ...
      <div className="flex gap-4">
        ...
        <Button variant="outline" onClick={fetchCourses} className="border-border text-foreground">搜索</Button>
      </div>
              ...
              <CardContent className="p-6 flex items-center gap-6">
                ...
                <div className="flex gap-2">
                  <Link href={`/admin/courses/${course.id}`}>
                    <Button variant="ghost" size="icon" className="hover:text-primary hover:bg-muted">
