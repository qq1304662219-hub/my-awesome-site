...
export function DiscoverHero() {
    ...
    return (
        <div className="relative w-full h-[400px] md:h-[500px] rounded-2xl overflow-hidden mb-12 group bg-black">
            <AnimatePresence mode="wait">
                ...
                >
                    ...
                    />
                    {/* Overlay Gradient - Fixed to black for text readability */}
                        ...
                        >
                            ...
                            <div className="flex items-center gap-4">
                                <Link href={`/video/${currentVideo.id}`}>
                                    <Button size="lg" className="rounded-full bg-white text-black hover:bg-gray-200 gap-2 px-8 h-12 text-base">
                ...
                {videos.map((_, idx) => (
                    <button
                        ...
                        className={`w-2 h-2 rounded-full transition-all duration-300 ${
                            idx === currentIndex ? "w-8 bg-blue-500" : "bg-white/30 hover:bg-white/50"
                        }`}
                    />
                ))}
            </div>
